...
{
    public abstract class QuadTree<TObject, TNode, TQuery> : ICollection<TObject> where TNode : QuadTreeFNodeCommon<TObject, TNode, TQuery>
    {
        ...
        protected abstract TNode CreateNode(Rectangle2D rect);
        ...
        {
            QuadTreePointRoot =
                CreateNode(new Rectangle2D(new Point2D(float.MinValue/2, float.MinValue/2), float.MaxValue, float.MaxValue));
        } 
        ...
        protected QuadTree(Rectangle2D rect)
        {
        ...
        {
            QuadTreePointRoot = CreateNode(new Rectangle2D( new Point2D(x, y), width, height));
        }
        ...
        /// <summary>
        /// Gets the Rectangle2D that bounds this QuadTree
        /// </summary>
        public Rectangle2D QuadRect
        {
        ...
        /// </summary>
        /// <param name="rect">The Rectangle2D to find objects in.</param>
