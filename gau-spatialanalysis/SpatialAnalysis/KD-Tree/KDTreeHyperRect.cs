...
namespace KDTree
{
    public struct KDTreeHyperRect<T>
	{
		private T[] minPoint;
		public T[] MinPoint
		{
		...
		public static KDTreeHyperRect<T> Infinite(int dimensions, ITypeMath<T> math)
		{
			var rect = new KDTreeHyperRect<T>();
		...
		public KDTreeHyperRect<T> Clone()
		{
			var rect = new KDTreeHyperRect<T>();
